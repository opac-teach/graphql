...
export type ResolversTypes = ResolversObject<{
  ...
  DeleteGenreResponse: ResolverTypeWrapper<Omit<DeleteGenreResponse, 'genre'> & { genre: ResolversTypes['Genre'] }>;
  ...
  Genre: ResolverTypeWrapper<Omit<Genre, 'songs'> & { songs?: Maybe<Array<Maybe<ResolversTypes['Song']>>> }>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  DeleteGenreResponse: Omit<DeleteGenreResponse, 'genre'> & { genre: ResolversParentTypes['Genre'] };
  ...
  Genre: Omit<Genre, 'songs'> & { songs?: Maybe<Array<Maybe<ResolversParentTypes['Song']>>> };
  ID: Scalars['ID']['output'];
...
export type GenreResolvers<ContextType = ResolversContext, ParentType extends ResolversParentTypes['Genre'] = ResolversParentTypes['Genre']> = ResolversObject<{
  ...
  songs?: Resolver<Maybe<Array<Maybe<ResolversTypes['Song']>>>, ParentType, ContextType, Partial<GenreSongsArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type MutationResolvers<ContextType = ResolversContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  createGenre?: Resolver<ResolversTypes['CreateGenreResponse'], ParentType, ContextType, Partial<MutationCreateGenreArgs>>;
  ...
  deleteGenre?: Resolver<ResolversTypes['DeleteSongResponse'], ParentType, ContextType, RequireFields<MutationDeleteGenreArgs, 'id'>>;
  ...
  updateGenre?: Resolver<ResolversTypes['UpdateGenreResponse'], ParentType, ContextType, RequireFields<MutationUpdateGenreArgs, 'id'>>;
